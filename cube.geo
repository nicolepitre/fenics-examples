...
Physical Surface("Surface 1", 11) = {bottom};
Physical Surface("Surface 2", 22) = {back};
Physical Surface("Surface 3", 33) = {top};
Physical Surface("Surface 4", 44) = {front};
Physical Surface("Surface 5", 55) = {right};
Physical Surface("Surface 6", 66) = {left};
  
Physical Volume ("Volume", 111) = {26};